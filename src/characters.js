...
export const characters = {
  ...
  sandi: {
    ...
    shortName: "Sandi",
    role: "The President's daughter, One's partner, and a political actor with knowledge, entanglement, and agency",
    intro:
