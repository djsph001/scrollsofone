...
.voc-title{font-family:'Fraunces',serif; font-optical-sizing:auto; font-weight:500;
  font-size:clamp(40px,7vw,72px); line-height:.96; letter-spacing:-.01em; margin:0 0 16px; color:var(--paper);}
.voc-sub{max-width:60ch; font-size:17px; color:var(--dim); margin:0 0 22px;}
.voc-stat{display:flex; flex-wrap:wrap; gap:18px; font-family:'Spline Sans Mono',monospace;
  font-size:12px; color:var(--faint);}
.voc-stat b{color:var(--paper);}
.voc-dot-canon{color:var(--amber);} .voc-dot-draft{color:var(--slate);}
.voc-dot-seed{color:var(--status-seed);} .voc-dot-repair{color:var(--rust);}
...
.voc-search{flex:1; min-width:240px; background:var(--surface-input); border:1px solid var(--line);
  color:var(--paper); font-family:'Newsreader',serif; font-size:16px; padding:12px 16px; border-radius:2px;}
.voc-search::placeholder{color:var(--faint);}
...
.voc-chip{background:transparent; border:1px solid var(--line-2); color:var(--dim);
  font-size:12px; padding:6px 11px; border-radius:999px; transition:all .15s;}
.voc-chip:hover{border-color:var(--amber-dim); color:var(--paper);}
.voc-chip.is-on{background:var(--amber); border-color:var(--amber); color:var(--bg); font-weight:500;}
...
.voc-rail-head{font-family:'Spline Sans Mono',monospace; font-size:10px; letter-spacing:.2em;
  text-transform:uppercase; color:var(--faint); margin:0 0 10px; padding-bottom:8px; border-bottom:1px solid var(--line);}
...
.voc-railbtn{display:flex; justify-content:space-between; align-items:center; gap:10px;
  background:transparent; border:none; color:var(--dim); text-align:left;
  font-size:12.5px; padding:7px 0; border-bottom:1px solid transparent; transition:color .14s;}
.voc-railbtn:hover{color:var(--paper);}
.voc-railbtn.is-on{color:var(--amber);}
.voc-count{font-size:11px; color:var(--faint);}
.voc-railbtn.is-on .voc-count{color:var(--amber-dim);}
.voc-pills{display:flex; flex-wrap:wrap; gap:7px;}
.voc-pill{background:transparent; border:1px solid var(--line-2); color:var(--dim);
  font-size:11.5px; padding:5px 10px; border-radius:2px; transition:all .14s;}
.voc-pill:hover{border-color:var(--amber-dim); color:var(--paper);}
.voc-pill.is-on{background:var(--amber); border-color:var(--amber); color:var(--bg); font-weight:500;}
...
.voc-resultcount{color:var(--faint); text-transform:uppercase;}
...
.voc-card-btn{width:100%; height:100%; text-align:left; background:var(--surface);
...
.voc-card-btn:hover{border-color:var(--line-2); background:var(--surface-2); transform:translateY(-2px);}
...
.voc-status-seed{color:var(--status-seed);} .voc-status-repair{color:var(--rust);}
...
.voc-card-sum{font-size:14px; line-height:1.45; color:var(--dim); margin:0; flex:1;}
...
.voc-who{font-family:'Spline Sans Mono',monospace; font-size:10px; color:var(--faint); text-align:right;}
.voc-empty{padding:60px 0; text-align:center; color:var(--dim); display:flex; flex-direction:column; gap:14px; align-items:center;}
.voc-overlay{position:fixed; inset:0; background:var(--scrim); backdrop-filter:blur(3px);
...
.voc-drawer{position:relative; width:min(520px,100%); height:100%; overflow-y:auto;
  background:var(--surface-input); border-left:1px solid var(--line-2); padding:54px 38px 48px;
...
.voc-close{position:absolute; top:20px; right:22px; background:none; border:none; color:var(--faint); font-size:15px;}
.voc-close:hover{color:var(--paper);}
...
.voc-drawer-title{font-family:'Fraunces',serif; font-weight:500; font-size:32px; line-height:1.05;
  margin:0 0 16px; color:var(--paper); letter-spacing:-.01em;}
...
.voc-who-tag{font-family:'Spline Sans Mono',monospace; font-size:10px; letter-spacing:.06em;
  color:var(--dim); border:1px solid var(--line-2); padding:4px 9px; border-radius:2px;}
.voc-drawer-sum{font-size:18px; line-height:1.5; color:var(--paper); margin:0 0 26px;}
.voc-drawer-body{border-top:1px solid var(--line); padding-top:22px;}
.voc-placeholder{font-size:14px; line-height:1.6; color:var(--faint); font-style:italic; margin:0;}
.voc-body-text{font-size:15px; line-height:1.6; color:var(--paper);}
...
.voc-foot{max-width:none; margin:0 auto; padding:22px 32px 40px; border-top:1px solid var(--line);
  ...
  font-family:'Spline Sans Mono',monospace; font-size:10.5px; letter-spacing:.06em; color:var(--faint);}
.voc-foot-link{color:var(--dim); text-decoration:none;
